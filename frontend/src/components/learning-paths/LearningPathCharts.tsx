/**
 * Employee Learning Paths — Chart Visualizations
 *
...
import { LearningTrend, DepartmentLearning } from './learningPathTypes';
...
export const TrendLine: React.FC<{
  ...
  title: string;
  lines: { key: keyof LearningTrend; color: string; label: string }[];
}> = ({ trends, title, lines }) => {
